...
{
    /**
     * A set of expectation methods useful for validating objects states. Only failed expectations
     * are recorded. These methods can be used directly: <code>Expect.expectTrue(...)</code>,
...
// MARK: - Methods
         ...
         * @param message   The identifying message for the {@link ExpectationException} (<code>null</code> okay)
         */
        public static void ExpectTrue(bool condition, string message = null) {
            if (!condition) {
                ThrowException(message);
            }
        }
         ...
         * @param message   The identifying message for the {@link ExpectationException} (<code>null</code> okay)
         */
        public static void ExpectFalse(bool condition, string message = null) {
            ExpectTrue(!condition, message);
        }
...
// MARK: - Methods
         ...
         * @param message The identifying message for the {@link ExpectationException} (<code>null</code> okay)
         */
        public static void ExpectNull(object obj, string message = null)
        {
            if (obj == null) {
                return;
            }
         ...
         * @param message The identifying message for the {@link ExpectationException} (<code>null</code> okay)
         */
        public static void ExpectNotNull(object obj, string message = null)
        {
            ExpectTrue(obj != null, message);
        }
...
// MARK: - Methods
         ...
         * TODO
         */
        public static void ExpectNullOrEmpty(string str, string message = null) {
            ExpectTrue(string.IsNullOrEmpty(str), message);
        }
...
//         * TODO
//         */
//        public static void ExpectNullOrEmpty(string[] values, string message = null) {
//            ExpectTrue(string.isNullOrEmpty(values), message);
//        }

        /**
         * TODO
         */
        public static void ExpectNotEmpty(string str, string message = null) {
            ExpectTrue(!string.IsNullOrEmpty(str), message);

// FIXME: Uncomment!
//            ExpectTrue(string.IsNotEmpty(str), message);
        }
...
//         * TODO
//         */
//        public static void ExpectNotEmpty(string[] values, string message = null) {
//            ExpectTrue(string.isNotEmpty(values), message);
//        }
...
//     }
         ...
         * TODO
         */
        public static void ExpectNotBlank(string str, string message = null) {
            ExpectTrue(!string.IsNullOrWhiteSpace(str), message);
        }
...
//     }
        ...
        private static void FailNotNull(string message, object actual)
        {
            var formatted = string.IsNullOrWhiteSpace(message) ? string.Empty : message + " ";
            ThrowException(formatted + "expected null, but was:<" + actual + ">");
        }
