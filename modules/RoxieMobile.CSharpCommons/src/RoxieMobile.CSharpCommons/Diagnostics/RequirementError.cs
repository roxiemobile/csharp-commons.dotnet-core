...
{
    // FIXME
    public class RequirementError : Exception
    {
// MARK: - Construction
        ...
        public RequirementError(string message)
            : base(message)
        { }

        public RequirementError(string message, Exception cause)
            : base(message, cause)
        { }

        public RequirementError(Exception cause)
            : base(null, cause)
        { }
