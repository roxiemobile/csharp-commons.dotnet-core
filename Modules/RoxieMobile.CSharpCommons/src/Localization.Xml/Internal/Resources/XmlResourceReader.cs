...
// ResourceReader.cs
// @link https://github.com/dotnet/runtime/blob/master/src/libraries/System.Private.CoreLib/src/System/Resources/ResourceReader.cs
...
{
#if RESOURCES_EXTENSIONS
    using XmlResourceReader = DeserializingResourceReader;
#endif
...
//        private int _version;
        ...
        // Used by ResourceSet and this class's enumerator.  Maps
        // resource name to a value.
        private IList<DictionaryEntry>? _resCache;
...
#else
        XmlResourceReader(string fileName)
#endif
        {
...
//#else
//        XmlResourceReader(Stream stream)
//#endif
//        {
//            if (stream == null)
...
//                    BinaryReader copyOfStore = _store;
                    XmlTextReader copyOfStore = _store;
...
//        }
        ...
        public IDictionaryEnumerator GetEnumerator()
        {
            ...
            return new XmlResourceEnumerator(this);
        }
...
//        }
        ...
        internal sealed class XmlResourceEnumerator : IDictionaryEnumerator
        {
...
//            private int _dataPosition; // cached for case-insensitive table
            ...
            internal XmlResourceEnumerator(XmlResourceReader reader)
            {
...
//                { ... }
                ...
                if (_reader._resCache == null) throw new InvalidOperationException(Messages.ResourceReaderIsClosed);
            ...
            public object Key
            {
                get
                {
                    if (_currentName == ENUM_DONE) throw new InvalidOperationException(Messages.InvalidOperation_EnumEnded);
                    if (!_currentIsValid) throw new InvalidOperationException(Messages.InvalidOperation_EnumNotStarted);
                    if (_reader._resCache == null) throw new InvalidOperationException(Messages.ResourceReaderIsClosed);
