...
// ResourceManager.cs
// @link https://github.com/dotnet/runtime/blob/master/src/libraries/System.Private.CoreLib/src/System/Resources/ResourceManager.cs
...
//        private bool _lookedForSatelliteContractVersion;
        ...
        private IXmlResourceGroveler _resourceGroveler = null!;
...
//            XmlResourceManagerMediator mediator = new XmlResourceManagerMediator(this);
...
//        }
        ...
        //
        private XmlResourceManager(string baseName, string resourceDir, Type? userResourceSet)
        {
            if (null == baseName)
...
//                throw new ArgumentException(SR.Argument_MustBeRuntimeAssembly);
            ...
            _moduleDir = Path.GetDirectoryName(MainAssembly.Location);
...
//            }
        ...
        protected virtual ResourceSet? InternalGetResourceSet(CultureInfo culture, bool createIfNotExists, bool tryParents)
        {
            ...
            XmlResourceFallbackManager mgr = new XmlResourceFallbackManager(culture, _neutralResourcesCulture, tryParents);
...
//#endif
            ...
            // lookup logic.
            XmlResourceFallbackManager mgr = new XmlResourceFallbackManager(culture, _neutralResourcesCulture, true);
            foreach (CultureInfo currentCultureInfo in mgr)
            {
...
//        }
        ...
        internal class XmlResourceManagerMediator
        {
            private readonly XmlResourceManager _rm;

            internal XmlResourceManagerMediator(XmlResourceManager rm)
            {
                if (rm == null)
                {
